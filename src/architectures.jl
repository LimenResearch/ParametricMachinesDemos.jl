...
DenseMachine(σ, dims::Vector{Int}; kwargs...) = DenseMachine(dims, σ; kwargs...)
...
ConvMachine(σ, dims::Vector{Int}; kwargs...) = ConvMachine(dims, σ; kwargs...)
...
RecurMachine(σ, dims::Vector{Int}; kwargs...) = RecurMachine(dims, σ; kwargs...)
